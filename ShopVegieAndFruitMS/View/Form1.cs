...
namespace ShopVegieAndFruitMS
{
    public partial class Form1 : Form
    {
        ...
        private void LoadRecord(Vegan vegan)
        {
            ...
            cmbType.Text = vegan.VeganTypesId.ToString();
        }
        ...
        private void btnADD_Click(object sender, EventArgs e)
        {
            ...
            newVegan.VeganTypesId = (int)cmbType.SelectedValue;
        ...
        private void btnSAll_Click(object sender, EventArgs e)
        {
            ...
            {
                lxbAll.Items.Add($"{item.Id}. {item.Name} Описание: {item.Discription} {item.Price}лв. Тип: {item.VeganTypes.NameType}");
            }
        }
        ...
        private void btnUPDATE_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                uddatedVegan.VeganTypesId = (int)cmbType.SelectedValue;
